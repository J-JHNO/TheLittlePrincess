...
public class AIControls : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        this.waypoints = new List<Transform>(waypointsHolder.GetComponentsInChildren<Transform>().Where(t => t != waypointsHolder));
    }
